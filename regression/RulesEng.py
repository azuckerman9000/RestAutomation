...
#Guid_AuthOnly = TPS.Authorize(base_url,sessiontoken,**GenericTests.AllRules["EcommSecureHappy"])
...
#TPS.Capture(base_url,sessiontoken,GenericTests.AllRules["ShippingAdrHappy"]["ServiceId"],Guid_AuthOnly)
#TPS.Capture(base_url,sessiontoken,GenericTests.AllRules["ShippingAdrHappy"]["ServiceId"],Guid_AuthOnly)
...
EcommTC = {"ServiceId":"A175B00001","ProfileId":"Generic_Ecomm_TC3","Phone":None,"IndustryType":"Ecommerce","ServiceName":"Generic Sandbox BCP Terminal Capture","CustomerPresent":"Ecommerce","CardBrandIdentifiers_3DSecure":None}
...
SIS.SaveMerchantProfiles(base_url,sessiontoken,**EcommTC)
